...
export class WelcomeComponent implements OnInit {
  ...
  showRadioState(index:number,address:number){
    let queryParams:NavigationExtras={
      queryParams:{
        'address':address
      }
   ...
   // this.router.navigate(['/home/detail/'],queryParams);
   this.router.navigate(['/home/radiostate'],queryParams);
  }

  showChannelState(index:number,address:number){
    let queryParams:NavigationExtras={
      queryParams:{
        'address':address
      }
   ...
   // this.router.navigate(['/home/detail/'],queryParams);
   this.router.navigate(['/home/channelstate'],queryParams);
  }

  showFrequencyState(index:number,address:number){
    let queryParams:NavigationExtras={
      queryParams:{
        'address':address
      }
   ...
   // this.router.navigate(['/home/detail/'],queryParams);
   this.router.navigate(['/home/frequencystate'],queryParams);
  }

  showEvaluationState(index:number,address:number){
    let queryParams:NavigationExtras={
      queryParams:{
        'address':address
      }
   ...
   // this.router.navigate(['/home/detail/'],queryParams);
   this.router.navigate(['/home/evaluationstate'],queryParams);
  }
